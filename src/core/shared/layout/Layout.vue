<template>
  <div class="flex h-screen bg-slate-100 overflow-hidden">
    ...
    <div class="flex-1 flex flex-col overflow-hidden min-h-0">
      <!-- Top Bar -->
      <header
        class="bg-white/80 backdrop-blur-sm shadow-sm border-b border-gray-200 z-10 relative"
      >
      ...
      <!-- Main Content (wallpaper fijo al alto del área; scroll solo en el contenido) -->
      <main class="flex-1 min-h-0 relative flex flex-col overflow-hidden">
        <AppIconWallpaper variant="content" :repeat="3" :veiled="false" />
        <div
          class="relative z-10 flex-1 min-h-0 overflow-y-auto px-4 sm:px-6 lg:px-8 py-8"
        >
          <nav
            class="mb-8 bg-white backdrop-blur-sm rounded-2xl border border-gray-100 shadow-lg w-full"
          >
            <div
            ...
            >
              ...
              <RouterLink
                to="/patient-screening-assignment"
    ...
    <Teleport to="body">
      <Transition name="app-drawer">
        ...
        >
          ...
          />
          <div
            class="app-drawer-panel flex h-full w-full max-w-5xl flex-col bg-white shadow-2xl"
            @click.stop
          >
...
import { AppIconWallpaper } from "../wallpaper";
