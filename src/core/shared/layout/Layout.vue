          ...
          <nav class="mb-8 bg-white/80 backdrop-blur-sm rounded-2xl border border-blue-100 shadow-sm p-6">
            <div class="flex flex-col sm:flex-row gap-3">
              <RouterLink to="/research"
                class="flex items-center gap-2 px-4 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl font-medium hover:from-blue-600 hover:to-indigo-700 transition-all shadow-sm hover:shadow-md">
              ...
              <RouterLink to="/patient-screening-assignment"
                ...
                <span>Asignar Tamizaje a Paciente</span>
              </RouterLink>
            </div>
          </nav>
