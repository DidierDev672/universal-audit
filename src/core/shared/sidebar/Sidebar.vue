<template>
  <div>
      ...
      <div class="flex flex-col h-full">
        ...
        >
          ...
          <div class="absolute inset-0 pointer-events-none" aria-hidden="true">
            ...
            <div
              class="absolute top-3 left-4 w-8 h-8 rounded-full bg-gray-100/20 flex items-center justify-center"
            >
              <svg
            ...
            <!-- Corcheas - top right -->
            <div
              class="absolute top-5 right-12 w-6 h-6 rounded-full bg-gray-400/20 flex items-center justify-center"
            >
              <svg
            ...
            <!-- Auriculares - middle left -->
            <div
              class="absolute top-16 left-2 w-10 h-10 rounded-full bg-slate-200/15 flex items-center justify-center"
            >
              <svg
            ...
            <!-- Parlantes - bottom right -->
            <div
              class="absolute bottom-4 right-4 w-9 h-9 rounded-full bg-gray-700/15 flex items-center justify-center"
            >
              <svg
            ...
            <!-- Clave de sol - middle right -->
            <div
              class="absolute top-12 right-6 w-8 h-8 rounded-full bg-slate-500/15 flex items-center justify-center"
            >
              <svg
                class="w-4 h-4 text-white/35"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
                <path
                  d="M12 3c-1.5 0-2.7.4-3.6 1.2C7.5 5 7 6.2 7 7.5c0 1.5.7 2.6 2 3.3V18c0 1.1.9 2 2 2s2-.9 2-2v-2h-2v-2h3c.6 0 1-.4 1-1V7.5C13 5.5 12.5 3 12 3zm0 7c-.6 0-1-.4-1-1s.4-1 1-1 1 .4 1 1-.4 1-1 1z"
                />
              </svg>
            </div>

            <!-- Ecualizador - bottom left -->
            <div
              class="absolute bottom-6 left-8 w-7 h-7 rounded-full bg-gray-100/20 flex items-center justify-center"
            >
              <svg
                class="w-3.5 h-3.5 text-white/30"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <!-- Disco de vinilo - center right -->
            <div
              class="absolute top-20 right-16 w-11 h-11 rounded-full bg-gray-400/10 flex items-center justify-center"
            >
              <svg
                class="w-6 h-6 text-white/25"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <div
              class="absolute top-2 left-24 w-6 h-6 rounded-full bg-slate-200/20 flex items-center justify-center"
            >
              <svg
                class="w-3 h-3 text-white/35"
                fill="none"
            ...
            <!-- Pentagrama - middle area -->
            <div
              class="absolute top-10 left-16 w-8 h-8 rounded-full bg-gray-700/10 flex items-center justify-center"
            >
              <svg
                class="w-4 h-4 text-white/25"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <!-- Pulso musical - bottom center -->
            <div
              class="absolute bottom-3 left-20 w-7 h-7 rounded-full bg-slate-500/15 flex items-center justify-center"
            >
              <svg
                class="w-3.5 h-3.5 text-white/30"
                fill="none"
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
              ...
              <div class="text-white">
                <h2 class="text-xl font-bold">Creación</h2>
                <p class="text-xs text-white/80">Portal de Gestión</p>
              </div>
            </div>
        ...
        <nav class="flex-1 px-4 py-6 overflow-y-auto">
          <div class="mb-4">
            <label class="sr-only" for="sidebar-search">Buscar en menu</label>
            <div class="relative">
              <svg
              ...
              <input
                ...
                class="h-10 w-full rounded-xl border border-gray-200 bg-white pl-9 pr-3 text-sm text-gray-700 shadow-sm outline-none transition-colors focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100"
              />
            </div>
          </div>
          ...
          <div ref="menuListRef" class="space-y-1">
            ...
            >
              ...
              <svg
                v-if="activeItem === 'crear-cuestionarios-tinnitus'"
                class="w-5 h-5 text-white animate-pulse"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            >
              ...
              <svg
                v-if="activeItem === 'asignar-cuestionarios-tinnitus'"
                class="w-5 h-5 text-white animate-pulse"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            >
              ...
              <div class="flex-1 text-left">
                <span class="font-semibold text-sm"
                  >Ver Respuestas Cuestionario</span
                >
                <p
                  :class="[
                    'text-xs mt-0.5',
              ...
              <svg
                v-if="activeItem === 'ver-respuestas-tinnitus'"
                class="w-5 h-5 text-white animate-pulse"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            >
              ...
              <div class="flex-1 text-left">
                ...
                >
                  Personalización de ambiente
                </p>
              </div>

              <svg
                v-if="activeItem === 'audio-mixer'"
                class="w-5 h-5 text-white animate-pulse"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            >
              ...
              <div class="flex-1 text-left">
                <span class="font-semibold text-sm">Anatomía 3D</span>
                <p
                  :class="[
                    'text-xs mt-0.5',
                    activeItem === 'anatomia-3d'
                ...
                >
                  Órganos y sistemas humanos
                </p>
              </div>

              <svg
                v-if="activeItem === 'anatomia-3d'"
                class="w-5 h-5 text-white animate-pulse"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <RouterLink
              ...
              :class="[
                'w-full flex items-center gap-4 px-4 py-4 rounded-2xl transition-all duration-200 group',
                activeItem === 'note-packages' || activeItem === 'note-package-detail'
            ...
            >
              ...
              <div class="flex-1 text-left">
                <span class="font-semibold text-sm">Paquetes de notas</span>
                <p
                  :class="[
                    'text-xs mt-0.5',
                    activeItem === 'note-packages' || activeItem === 'note-package-detail'
                ...
                >
                  Ver secciones y notas guardadas
                </p>
              </div>
              <svg
                v-if="activeItem === 'note-packages' || activeItem === 'note-package-detail'"
                class="w-5 h-5 text-white animate-pulse"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <RouterLink
              ...
              :class="[
                'w-full flex items-center gap-4 px-4 py-4 rounded-2xl transition-all duration-200 group',
                activeItem === 'note-packages-compose'
                  ? 'bg-gradient-to-r from-violet-600 to-purple-600 text-white shadow-lg shadow-violet-500/30 scale-105'
                  : 'text-gray-700 hover:bg-violet-50 hover:text-violet-700',
              ]"
            >
              ...
              <div class="flex-1 text-left">
                <span class="font-semibold text-sm">Crear paquete de notas</span>
                <p
                  :class="[
                    'text-xs mt-0.5',
                    activeItem === 'note-packages-compose'
                ...
                >
                  Notas individuales → sección global
                </p>
              </div>
              <svg
                v-if="activeItem === 'note-packages-compose'"
                class="w-5 h-5 text-white animate-pulse"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            >
              ...
              <div class="flex-1 text-left">
                <span class="font-semibold text-sm"
                  >Ver Respuestas de Tamizaje</span
                >
                <p
                  :class="[
                    'text-xs mt-0.5',
              ...
              <svg
                v-if="activeItem === 'screening-responses'"
                class="w-5 h-5 text-white animate-pulse"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <RouterLink
              ...
              :class="[
                'w-full flex items-center gap-4 px-4 py-4 rounded-2xl transition-all duration-200 group',
                activeItem === 'crear-registro-paciente'
                  ? 'bg-linear-to-r from-emerald-600 to-teal-600 text-white shadow-lg shadow-emerald-500/30 scale-105'
                  : 'text-gray-700 hover:bg-emerald-50 hover:text-emerald-700',
              ]"
            >
              ...
              <svg
                v-if="activeItem === 'crear-registro-paciente'"
                class="w-5 h-5 text-white animate-pulse"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <RouterLink
              ...
              :class="[
                'w-full flex items-center gap-4 px-4 py-4 rounded-2xl transition-all duration-200 group',
                activeItem === 'crear-usuario-sistema'
                  ? 'bg-linear-to-r from-emerald-600 to-teal-600 text-white shadow-lg shadow-emerald-500/30 scale-105'
                  : 'text-gray-700 hover:bg-emerald-50 hover:text-emerald-700',
              ]"
            >
              ...
              <svg
                v-if="activeItem === 'crear-usuario-sistema'"
                class="w-5 h-5 text-white animate-pulse"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            >
              ...
              <svg
                v-if="activeItem === 'perfil-usuario'"
                class="w-5 h-5 text-white animate-pulse"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <!-- AI — Configuración modelo -->
            <RouterLink
              to="/ai-model-config"
              :class="[
                'w-full flex items-center gap-4 px-4 py-4 rounded-2xl transition-all duration-200 group',
                activeItem === 'ai-model-config'
                  ? 'bg-gradient-to-r from-emerald-600 to-teal-600 text-white shadow-lg shadow-emerald-500/30 scale-105'
                  : 'text-gray-700 hover:bg-emerald-50 hover:text-emerald-700',
              ]"
            >
              ...
              <div class="flex-1 text-left">
                <span class="font-semibold text-sm">AI — Modelo y API key</span>
                <p
                  :class="[
                    'text-xs mt-0.5',
                    activeItem === 'ai-model-config'
                ...
                >
                  Codex, Gemini o Claude
                </p>
              </div>
              <svg
                v-if="activeItem === 'ai-model-config'"
                class="w-5 h-5 text-white animate-pulse"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <!-- AI — Image Attachments (Spanish) -->
            <RouterLink
              to="/ai-image-analyzer"
              :class="[
                'w-full flex items-center gap-4 px-4 py-4 rounded-2xl transition-all duration-200 group',
                activeItem === 'ai-image-attachments-es'
                  ? 'bg-gradient-to-r from-emerald-600 to-teal-600 text-white shadow-lg shadow-emerald-500/30 scale-105'
                  : 'text-gray-700 hover:bg-emerald-50 hover:text-emerald-700',
              ]"
            >
              ...
              >
                ...
                >
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="M4 16l4-4a3 3 0 014.243 0L16 15.757l1.757-1.757a3 3 0 014.243 0L24 16M4 20h16a2 2 0 002-2V6a2 2 0 00-2-2H4a2 2 0 00-2 2v12a2 2 0 002 2z"
                  />
                </svg>
              </div>
              <div class="flex-1 text-left">
                <span class="font-semibold text-sm">Anexos de imagenes</span>
                <p
                  :class="[
                    'text-xs mt-0.5',
                    activeItem === 'ai-image-attachments-es'
                ...
                >
                  Adjuntar imagenes y analizar con IA
                </p>
              </div>
              <svg
                v-if="activeItem === 'ai-image-attachments-es'"
                class="w-5 h-5 text-white animate-pulse"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <!-- AI — Analsis de anexos -->
            <RouterLink
              to="/ai-image-analyses"
              :class="[
                'w-full flex items-center gap-4 px-4 py-4 rounded-2xl transition-all duration-200 group',
                activeItem === 'ai-image-analyses'
                  ? 'bg-gradient-to-r from-emerald-600 to-teal-600 text-white shadow-lg shadow-emerald-500/30 scale-105'
                  : 'text-gray-700 hover:bg-emerald-50 hover:text-emerald-700',
              ]"
            >
              ...
              >
                ...
                >
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="M3 7h5l2 2h11v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7zm6 6h6m-6 3h4"
                  />
                </svg>
              </div>
              <div class="flex-1 text-left">
                <span class="font-semibold text-sm">Analsis de anexos - IA</span>
                <p
                  :class="[
                    'text-xs mt-0.5',
                    activeItem === 'ai-image-analyses'
                ...
                >
                  Ver carpetas de análisis de imágenes
                </p>
              </div>
              <svg
                v-if="activeItem === 'ai-image-analyses'"
                class="w-5 h-5 text-white animate-pulse"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
          ...
          <!-- Info Card -->
          <div
            class="bg-linear-to-br from-emerald-50 to-teal-50 rounded-2xl p-4 border border-emerald-100"
          >
            ...
            <p class="text-xs text-gray-600 leading-relaxed">
              Crea nuevos registros y gestiona el sistema de forma eficiente.
            </p>
          </div>
        </nav>
        ...
        <div
          class="p-4 border-t border-indigo-100 bg-gradient-to-br from-gray-50 to-indigo-50"
        >
          <!-- Logout Button -->
          <button
    ...
    <button
      v-if="!isOpen"
      @click="$emit('toggle')"
      class="fixed top-4 left-4 z-40 p-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl shadow-lg transition-all hover:scale-105"
