<template>
  ...
  >
    <!-- Container principal -->
    <div
      class="w-full max-w-6xl flex flex-col md:flex-row bg-white rounded-3xl shadow-2xl overflow-hidden"
    >
      ...
      >
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            v-for="(particle, idx) in floatingIcons"
            :key="idx"
            class="floating-icon"
            :style="{
              left: particle.left + '%',
            ...
            <div
              ...
              :style="{
                ...
                filter: particle.glow
                  ? `drop-shadow(0 0 10px ${particle.icon.color})`
                  : 'none',
              }"
        ...
        <div class="relative z-10">
          ...
          <div class="my-12">
            <div
              class="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20"
            >
              <svg
                class="w-full h-48"
                viewBox="0 0 200 200"
              ...
              >
                ...
                />
                <path
                  d="M70 100 Q70 60, 100 60 Q130 60, 130 100"
                  stroke="white"
                  stroke-width="4"
                  stroke-linecap="round"
                />
        ...
        <div class="max-w-md mx-auto w-full">
          ...
          >
            <div class="flex items-start">
              <svg
                class="w-5 h-5 text-red-500 mt-0.5 mr-3 shrink-0"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  :class="{
                    'border-red-500 focus:ring-red-500': formErrors.email,
                  }"
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  :class="{
                    'border-red-500 focus:ring-red-500': formErrors.password,
                  }"
                  placeholder="••••••••"
                />
                <button
          ...
          <!-- Footer -->
          <div
            class="mt-8 pt-6 border-t border-gray-200 text-center text-xs text-gray-500"
          >
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (
      ...
      errorMessage.value =
        "El servidor está tardando demasiado en responder. Verifica que el servidor esté corriendo en http://localhost:3000";
      ...
      errorMessage.value =
        "No se pudo conectar con el servidor. Verifica que el servidor esté corriendo en http://localhost:3000";
    } else {
      errorMessage.value =
