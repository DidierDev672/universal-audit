   ...
   <div class="space-y-6">
    ...
    <Teleport to="body">
      <Transition name="app-modal">
        <div v-if="soundToDelete" class="app-modal-root">
          <div
          ...
          <div
            ...
            @click.self="soundToDelete = null"
          >
            <div
              class="app-modal-panel app-modal-panel--sheet bg-white rounded-3xl p-8 max-w-md shadow-2xl w-full"
              role="dialog"
              aria-modal="true"
              @click.stop
            >
              ...
              <footer class="app-modal-footer flex gap-3">
                <button
                  @click="soundToDelete = null"
                  class="app-modal-btn flex-1 px-6 py-3 bg-gray-100 text-gray-700 rounded-xl font-medium hover:bg-gray-200 transition-all"
                >
                  Cancelar
                </button>
                <button
                  @click="confirmDelete"
                  class="app-modal-btn flex-1 px-6 py-3 bg-red-600 text-white rounded-xl font-medium hover:bg-red-700 transition-all"
                >
                  Eliminar
                </button>
              </footer>
